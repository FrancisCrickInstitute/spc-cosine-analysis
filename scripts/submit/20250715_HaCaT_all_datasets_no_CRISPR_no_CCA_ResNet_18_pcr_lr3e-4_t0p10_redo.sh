...
# Path to config file
CONFIG_PATH="/nemo/stp/hts/working/Joe_Tuersley/code/spc-cosine-analysis/scripts/config/20250715_HaCaT_all_datasets_no_CRISPR_no_CCA_ResNet_18_pcr_lr3e-4_t0p10_redo.yml"
