...
#SBATCH --job-name=ResNet18_no_CRISPR_cosine_analysis
#SBATCH --mem=1024G
#SBATCH --time=8:00:00
...
# Path to config file
CONFIG_PATH="/nemo/stp/hts/working/Joe_Tuersley/code/spc-cosine-analysis/scripts/config/20250715_HaCaT_all_datasets_no_CRISPR_ResNet_18_pcr_lr3e-4_t0p10_redo_2.yml"
