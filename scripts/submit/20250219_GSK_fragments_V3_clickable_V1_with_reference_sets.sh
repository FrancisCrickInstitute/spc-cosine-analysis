...
# Path to config file
CONFIG_PATH="/nemo/stp/hts/working/Joe_Tuersley/code/spc-cosine-analysis/scripts/config/20250219_GSK_fragments_V3_clickable_V1_with_reference_sets_new.yml"
